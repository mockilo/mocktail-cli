...
function neonGlow(text: string, step: number): string {
...
async function animateCocktailBubbles(cycles: number = 8): Promise<void> {
  const frames = [
    '     🍸       ',
    '    🍸        ',
    '     🍸       ',
...
async function printMocktailLogo(): Promise<void> {
